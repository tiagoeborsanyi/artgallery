  ...
  return (
    <div className={`newart-form-control space ${props.addClassFormControl}`}>
      ...
      <div className="newart-image__preview" style={{width: props.width, height: props.height}}>
        <input className="newart-image__input" style={{width: props.width, height: props.height}} type="file" accept=".jpg,.png,.jpeg" />
          <div className="newart-image__img" style={{width: props.width, height: props.height, backgroundImage: `url(${props.imagePreviewURL})`}}></div>
